...
"[project]/app/api/user/notifications/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    if (sinceParam) {
        ...
        if (!isNaN(since.getTime())) where.createdAt = {
            gt: since
        };
    }
    const items = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].notification.findMany({
        where,
        orderBy: {
            createdAt: 'desc'
        },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bb558d7f._.js.map