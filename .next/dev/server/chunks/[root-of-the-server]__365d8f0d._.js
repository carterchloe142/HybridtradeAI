...
async function runBaselineCycle(input) {
    ...
    for (const inv of active){
        ...
        try {
            const n = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].notification.create({
                data: {
                    userId: inv.userId,
                    type: 'profit',
                    title: 'Weekly ROI',
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sse$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["publish"])(`user:${String(inv.userId)}`, {
                id: n.id,
                type: n.type,
                title: n.title,
                message: n.message,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__365d8f0d._.js.map