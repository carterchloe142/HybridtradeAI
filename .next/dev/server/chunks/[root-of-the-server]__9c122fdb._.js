...
"[project]/Documents/trae_projects/HYBRID TRADE AI/pages/api/admin/performance.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const RoiSchema = __TURBOPACK__imported__module__$5b$externals$5d2f$zod__$5b$external$5d$__$28$zod$2c$__esm_import$29$__["z"].record(__TURBOPACK__imported__module__$5b$externals$5d2f$zod__$5b$external$5d$__$28$zod$2c$__esm_import$29$__["z"].number().nonnegative());
const BodySchema = __TURBOPACK__imported__module__$5b$externals$5d2f$zod__$5b$external$5d$__$28$zod$2c$__esm_import$29$__["z"].object({
    weekEnding: __TURBOPACK__imported__module__$5b$externals$5d2f$zod__$5b$external$5d$__$28$zod$2c$__esm_import$29$__["z"].string().refine((s)=>!isNaN(Date.parse(s)), {
...
async function handler(req, res) {
    ...
    try {
        ...
        let result = null;
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$trae_projects$2f$HYBRID__TRADE__AI$2f$lib$2f$supabaseServer$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["supabaseServer"].from('performance').upsert(payload, {
                onConflict: 'week_ending'
            }).select().maybeSingle();
            if (error) throw error;
            result = data;
        } catch (e) {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$trae_projects$2f$HYBRID__TRADE__AI$2f$lib$2f$supabaseServer$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["supabaseServer"].from('performance').insert(payload).select().maybeSingle();
            if (error) return res.status(500).json({
                error: 'Failed to insert performance',
        ...
        return res.status(500).json({
            ok: false,
            error: err?.message || 'Failed to upsert performance'
        });
    }
}
__turbopack_async_result__();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9c122fdb._.js.map