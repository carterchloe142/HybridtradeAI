...
"[project]/pages/api/deposit.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    const { error: invErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseServer$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["supabaseServer"].from('investments').insert({
        user_id: userId,
        plan_id: planId,
        amount_usd: amount,
        status: 'active'
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4e4517ef._.js.map