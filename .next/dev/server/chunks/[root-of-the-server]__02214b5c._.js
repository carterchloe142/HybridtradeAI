...
"[project]/Documents/trae_projects/HYBRID TRADE AI/pages/api/admin/users/invite-admin.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    try {
        ...
        const { data: invite, error: inviteErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$trae_projects$2f$HYBRID__TRADE__AI$2f$lib$2f$supabaseServer$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["supabaseServer"].auth.admin.inviteUserByEmail(email);
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$trae_projects$2f$HYBRID__TRADE__AI$2f$lib$2f$supabaseServer$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["supabaseServer"].from('profiles').upsert({
            user_id: userId,
            role: 'admin',
            is_admin: true
        }, {
        ...
        return res.status(500).json({
            ok: false,
            error: e?.message || 'Invite-admin failed'
        });
    }
}
__turbopack_async_result__();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__02214b5c._.js.map