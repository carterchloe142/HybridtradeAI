...
"[project]/Documents/trae_projects/HYBRID TRADE AI/pages/api/admin/credit-user.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    if (req.method === 'GET') {
        ...
        try {
            const [actions, total] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$trae_projects$2f$HYBRID__TRADE__AI$2f$src$2f$lib$2f$prisma$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].adminAction.findMany({
                    where: {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$trae_projects$2f$HYBRID__TRADE__AI$2f$src$2f$lib$2f$prisma$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].adminAction.count({
                    where: {
                        action: 'MANUAL_CREDIT'
                    }
                })
        ...
        // Fallback: read via Supabase service role
        const { data, error, count } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$trae_projects$2f$HYBRID__TRADE__AI$2f$lib$2f$supabaseServer$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["supabaseServer"].from('AdminAction').select('id,adminId,userId,amount,action,note,status,createdAt', {
            count: 'exact'
        }).eq('action', 'MANUAL_CREDIT').order('createdAt', {
            ascending: false
    ...
    try {
        ...
        if (threshold && amount > threshold) {
            const pending = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$trae_projects$2f$HYBRID__TRADE__AI$2f$src$2f$lib$2f$prisma$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].adminAction.create({
                data: {
                    adminId,
        ...
        const { data: existing, error: selectErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$trae_projects$2f$HYBRID__TRADE__AI$2f$lib$2f$supabaseServer$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["supabaseServer"].from('wallets').select('id,balance').eq('user_id', resolvedUserId).eq('currency', currency).maybeSingle();
        ...
        if (!walletId) {
            const { data: inserted, error: insertErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$trae_projects$2f$HYBRID__TRADE__AI$2f$lib$2f$supabaseServer$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["supabaseServer"].from('wallets').insert({
        ...
        const { error: updateErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$trae_projects$2f$HYBRID__TRADE__AI$2f$lib$2f$supabaseServer$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["supabaseServer"].from('wallets').update({
            balance: newAmount
        }).eq('id', walletId);
        ...
        let txn = null;
        try {
            txn = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$trae_projects$2f$HYBRID__TRADE__AI$2f$src$2f$lib$2f$prisma$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].walletTransaction.create({
                data: {
                    walletId: walletId,
                    amount: amount.toString(),
                    type: 'CREDIT',
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$trae_projects$2f$HYBRID__TRADE__AI$2f$src$2f$lib$2f$prisma$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].adminAction.create({
                data: {
                    adminId,
                    userId: resolvedUserId,
                    amount: amount.toString(),
        ...
        try {
            const notif = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$trae_projects$2f$HYBRID__TRADE__AI$2f$src$2f$lib$2f$prisma$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].notification.create({
                data: {
                    userId: resolvedUserId,
                    type: 'manual_credit',
                    title: 'Manual Credit',
            ...
            try {
                const { publish } = await __turbopack_context__.A("[project]/Documents/trae_projects/HYBRID TRADE AI/src/lib/sse.ts [api] (ecmascript, async loader)");
...
async function resolveSupabaseUserId({ userId, email }) {
    ...
    if (emailToUse) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$trae_projects$2f$HYBRID__TRADE__AI$2f$lib$2f$supabaseServer$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["supabaseServer"].from('profiles').select('user_id').eq('email', emailToUse).maybeSingle();
    ...
    if (userId && userId.startsWith('c') && userId.length >= 24) {
        try {
            const user = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$trae_projects$2f$HYBRID__TRADE__AI$2f$src$2f$lib$2f$prisma$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].user.findUnique({
                where: {
                    id: userId
                }
            });
            ...
            if (emailFromPrisma) {
                const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$trae_projects$2f$HYBRID__TRADE__AI$2f$lib$2f$supabaseServer$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["supabaseServer"].from('profiles').select('user_id').eq('email', emailFromPrisma).maybeSingle();
                if (!error && data?.user_id) return data.user_id;
            }
        } catch  {}
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__963aac87._.js.map