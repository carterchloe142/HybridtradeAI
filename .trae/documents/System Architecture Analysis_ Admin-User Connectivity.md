# Admin-User Functionality Map

This report details how Admin actions (Backend/Dashboard) directly impact User features (Frontend/API) through shared database states.
