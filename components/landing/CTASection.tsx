  ...
  return (
    <section className="relative py-24 px-6 md:px-12 lg:px-24 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          <Link href="/auth/register" className="inline-flex items-center gap-2 px-10 py-5 bg-white text-black font-bold rounded-full text-lg hover:bg-slate-200 transition-colors shadow-2xl shadow-white/10 hover:shadow-white/20 transform hover:-translate-y-1">
