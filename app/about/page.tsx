  ...
  return (
    <div className="space-y-24 pb-12">
      ...
      <div className="fixed inset-0 z-[-1] overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-[20%] right-[-10%] w-[30%] h-[50%] bg-purple-900/10 rounded-full blur-[120px] animate-pulse delay-1000" />
        <div className="absolute bottom-[-10%] left-[20%] w-[50%] h-[40%] bg-indigo-900/10 rounded-full blur-[120px] animate-pulse delay-2000" />
      </div>

      {/* Hero Section */}
      <section className="relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-[#0f172a] via-[#1e1b4b] to-black border border-white/10 p-10 md:p-24 text-center shadow-2xl shadow-blue-900/20">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          >
            ...
            <span className="text-sm font-medium text-blue-200">Next-Gen Hybrid Investing</span>
          </motion.div>
          ...
          <motion.h1 
            ...
            className="text-5xl md:text-7xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-b from-white via-white to-white/50 mb-6 drop-shadow-2xl"
          >
            {t('about_page.title')}
          </motion.h1>
      ...
      {/* Live Metrics Strip */}
      <div className="overflow-hidden py-4 border-y border-white/5 bg-black/20 backdrop-blur-sm -mx-4 md:-mx-8 lg:-mx-12">
        <motion.div 
          animate={{ x: ["0%", "-50%"] }} 
        ...
        >
          {[...Array(2)].map((_, i) => (
            <div key={i} className="flex gap-16 text-sm font-mono text-slate-400">
        ...
        >
          {[
            ...
            <motion.div 
              ...
              className={`group relative overflow-hidden rounded-2xl bg-slate-900/50 backdrop-blur-xl border border-white/5 p-8 transition-all duration-300 ${item.color}`}
            >
              <div className="absolute inset-0 bg-gradient-to-br from-white/[0.03] to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
              {/* Animated corner accent */}
              <div className="absolute -top-10 -right-10 w-20 h-20 bg-white/5 blur-2xl group-hover:bg-white/10 transition-colors" />
              
              <div className="relative z-10">
                <div className="mb-6 p-3 bg-white/5 w-fit rounded-xl border border-white/10 group-hover:scale-110 group-hover:bg-white/10 transition-all duration-300 shadow-lg">
                  {streamIcons[item.key]}
                </div>
                <h3 className="text-xl font-bold mb-3 text-slate-100 group-hover:text-white transition-colors">{t(`about_page.streams.${item.key}.title`)}</h3>
      ...
      <section className="relative">
        ...
        <div className="bg-black/40 backdrop-blur-2xl rounded-[2.5rem] p-8 md:p-16 border border-white/10">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">{t('about_page.investment_plans')}</h2>
            <p className="text-slate-400 max-w-2xl mx-auto">Choose the tier that aligns with your financial goals. Upgrade anytime.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div 
                ...
                className="h-full"
              >
                <TiltCard className={`flex flex-col rounded-3xl bg-slate-900/80 p-8 border ${plan.border} ${plan.glow} shadow-2xl transition-all duration-300 h-full`}>
                  {plan.popular && (
                  ...
                  <div className="flex flex-col items-center mb-8 relative z-10">
                    ...
                    <h3 className="text-2xl font-bold text-slate-100 group-hover:text-white transition-colors">{t(`about_page.plans.${plan.key}.title`)}</h3>
                    <div className="mt-2 text-xs font-mono text-slate-400 uppercase tracking-widest border border-white/10 px-3 py-1 rounded group-hover:border-white/20 transition-colors">
                  ...
                  <div className="space-y-6 flex-1 relative z-10">
                    <div className="space-y-4">
                      <div className="flex gap-4 items-start">
                        ...
                        <span className="text-sm text-slate-300">{t(`about_page.plans.${plan.key}.streams`)}</span>
                      </div>
                      <div className="flex gap-4 items-start">
                        <div className="mt-1 p-1 rounded-full bg-blue-500/20">
                          <Zap className="w-3 h-3 text-blue-400" />
                        </div>
                        <span className="text-sm text-slate-300">{t(`about_page.plans.${plan.key}.weekly`)}</span>
                      </div>
                      <div className="flex gap-4 items-start">
                        <div className="mt-1 p-1 rounded-full bg-purple-500/20">
                          <ShieldCheck className="w-3 h-3 text-purple-400" />
                        </div>
                        <span className="text-sm text-slate-300">{t(`about_page.plans.${plan.key}.benefits`)}</span>
                      </div>
                    </div>
                  </div>
